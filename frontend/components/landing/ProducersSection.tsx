...
const producers = [
	{
		name: "Clearwater Organics",
		location: "Saskatchewan",
		image: "/images/Clearwater_Organics.png",
		certs: ["Pro-Cert Organic", "Non-GMO Project"],
	},
	{
		name: "Durum King Farms",
		location: "Alberta",
		image: "/images/Durum_King_Farms.png",
		certs: ["CSGA Certified Seed", "HACCP Certified"],
	},
	{
		name: "Prairie Pulses Inc.",
		location: "Manitoba",
		image: "/images/Prairie Pulses Inc.png",
		certs: ["GlobalG.A.P.", "ISO 22000"],
	},
];
			...
			<div className="container mx-auto px-4 md:px-6">
				...
				>
					...
					<p className="mt-4 max-w-2xl mx-auto text-lg text-foreground/70">
						The foundation of our marketplace is a network of Canada's most
						reputable and quality-driven operations.
					</p>
				</motion.div>
					...
					{producers.map((producer) => (
						<motion.div key={producer.name} variants={cardVariants}>
							<PGPCard className="overflow-hidden h-full flex flex-col text-left group">
								...
								<PGPCardHeader>
									<PGPCardTitle className="text-2xl font-serif">
										{producer.name}
									</PGPCardTitle>
								...
								<PGPCardContent className="flex flex-col flex-grow">
									<div className="flex-grow">
										...
										<div className="flex flex-wrap gap-2">
											{producer.certs.map((cert) => (
												<span
													key={cert}
													className="text-xs font-medium bg-stone-100 text-foreground/80 px-2 py-1 rounded-full border border-stone-200"
												>
													{cert}
												</span>
											))}
									...
									<PGPButton
										variant="outline"
										className="mt-6 w-full group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary transition-all duration-300"
									>
										View Profile
									</PGPButton>
								</PGPCardContent>
