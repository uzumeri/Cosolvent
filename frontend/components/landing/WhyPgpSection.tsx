...
const mainFeature = {
	...
	description:
		"PrairieGrain was built on a simple idea: to create the most efficient and trustworthy path from the producer’s bin to the global buyer’s destination. We leverage technology to remove intermediaries, providing clear communication and unprecedented visibility into the supply chain.",
};
...
const supportingFeatures = [
	{
		...
		description:
			"Negotiate directly with our network of verified Canadian Prairie producers.",
	},
	{
		icon: <ShieldCheck />,
		title: "Assured Crop Quality",
		description:
			"Access detailed crop data, from protein levels to grade, before you commit.",
	},
	{
		icon: <DatabaseZap />,
		title: "Full Lot Traceability",
		description:
			"Track your grain from the farm to the port for complete peace of mind.",
	},
	{
		icon: <Truck />,
		title: "Streamlined Logistics",
		description:
			"We handle the complexities of transport, documentation, and freight forwarding.",
	},
];
			...
			<div className="container mx-auto px-4 md:px-6">
				...
				>
					...
					<p className="mt-4 max-w-2xl mx-auto text-lg text-foreground/70">
						We provide the tools and trust necessary for modern agricultural
						trade.
					</p>
				</motion.div>
					...
					>
						<PGPCard className="h-full p-6 bg-gradient-to-br from-stone-50 to-white shadow-xl">
							<PGPCardHeader>
								...
								<PGPCardTitle className="text-2xl font-semibold">
									{mainFeature.title}
								</PGPCardTitle>
							</PGPCardHeader>
							<PGPCardContent>
							...
							>
								<PGPCard className="h-full transform hover:-translate-y-1 transition-transform duration-300 hover:shadow-lg">
									<PGPCardHeader className="flex-row items-start gap-4">
										...
										<div>
											<PGPCardTitle className="text-lg">
												{feature.title}
											</PGPCardTitle>
