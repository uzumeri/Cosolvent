  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        <p className="mt-3 text-lg text-stone-300">Log in to access the marketplace.</p>
      </div>
      ...
      <form className="mt-8 space-y-6">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link href="#" className="text-sm text-primary/80 hover:text-primary font-medium transition-colors">
              Forgot Password?
            </Link>
          </div>
          <Input 
